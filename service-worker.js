const CACHE_NAME = "lawh-warsh-shell-v4";
...
//
// ملاحظة: Supabase (بيانات الآيات، bookmarks، إلخ) ماشي مغطى هنا قصدا —
// بيانات الآيات دابا مخزنة فـ IndexedDB مباشرة من التطبيق (index.html)، ماشي عبر الـ SW.
